...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Projects = userHasManyProjects{
		...
		RelationField: field.NewRelation("Projects", "model.Project"),
	}
...
func (a userHasManyProjects) Model(m *model.User) *userHasManyProjectsTx {
	return &userHasManyProjectsTx{a.db.Model(m).Association(a.Name())}
}

type userHasManyProjectsTx struct{ tx *gorm.Association }

func (a userHasManyProjectsTx) Find() (result []*model.Project, err error) {
	return result, a.tx.Find(&result)
}

func (a userHasManyProjectsTx) Append(values ...*model.Project) (err error) {
...
func (a userHasManyProjectsTx) Replace(values ...*model.Project) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userHasManyProjectsTx) Delete(values ...*model.Project) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
